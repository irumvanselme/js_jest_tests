...
describe("Put endpoint", () => {
  ...
  test("should return 201 if the turtorial is updated", async () => {
    jest
      ...
      .mockReturnValue(Promise.resolve(updatedTurtorial));
...
describe("Delete endpoints", () => {
  it("should delete one tutorial successfully", async () => {
    jest
      .spyOn(Tutorial, "findByIdAndRemove")
  ...
  it("should delete all tutorials successfully", async () => {
    jest.spyOn(Tutorial, "deleteMany").mockReturnValue(Promise.resolve(true));
...
describe("GET endpoints", () => {
  it("should return tutorial by id successfully", async () => {
    ...
    jest.spyOn(Tutorial, "findById").mockReturnValue(Promise.resolve(tutorial));
